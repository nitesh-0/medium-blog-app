    ...
    return <div>
        ...
        <div className="flex justify-center w-full pt-8"> 
            <div className="max-w-screen-lg w-full">
                ...
                }} type="text" className="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 
    ...
    return <div className="mt-2">
        <div className="w-full mb-4 ">
            ...
            <div className="my-2 bg-white rounded-b-lg w-full">
                ...
                <textarea onChange={onChange} id="editor" rows={8} className="focus:outline-none block w-full px-0 text-sm text-gray-800 bg-white border-0 
                 pl-2" placeholder="Write an article..." required />
            </div>
        </div>
       </div>
    </div>
